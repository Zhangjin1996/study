 ...
 * @Descripttion: 
 * @Author: ZJ
 * @Date: 2021-04-30 15:07:06
 * @LastEditors: ZJ
 * @LastEditTime: 2021-05-06 17:44:25
 */
...
// 引入ReadmeWebpackPlugin 插件
const ReadmeWebpackPlugin = require('./public/plugins/readMeWebpackPlugin');

// 引入ReadmeWebpackPlugin插件
const RemoveCommentsPlugin = require('./public/plugins/removeCommentsPlugin');
...
module.exports = {
  ...
  plugins: [
    ...
    new ReadmeWebpackPlugin(() => {
      console.log('readme插件开始工作啦, emit 事件发生啦')
    }, () => {
      console.log('done 事件发生啦，成功构建完成')
    }),
